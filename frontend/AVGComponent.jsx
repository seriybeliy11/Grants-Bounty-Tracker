  ...
  return (
    <Card style={{borderRadius: '16px'}}>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <Metric style = {{fontSize: '15px', fontFamily: 'Manrope-900'}}>AVG Metric</Metric>
      ...
      <Metric style = {{fontSize: '27px', fontFamily: 'Manrope-900'}}>86.2</Metric>
    </Card>
  );
};

export default AVGAgentCard;
