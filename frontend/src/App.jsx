...
import MyAccComponent from './PretteEye';
import ControlSystemTalking from './ControlSystemTalking';
  ...
  return (
    <div className='app-container'>
      ...
      <main className="main-content">
        ...
        <div className='commenters-metrics-text'>
          <Title style={{fontFamily: 'Manrope-900', fontSize: '22px', lineHeight: '28px'}}>AI resume</Title>
        </div>
        <div className='c-agent-component'>
          <MyAccComponent/>
        </div>
        <div className='commenters-metrics-text'>
          <Title style={{fontFamily: 'Manrope-900', fontSize: '22px', lineHeight: '28px'}}>Control System Talking</Title>
        </div>
        <div className='c-agent-component flex'>
          <div className='your-inner-component'>
            <ControlSystemTalking/>
          </div>
        </div>
        </div>
